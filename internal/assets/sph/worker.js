...
<body>
  <div class="wrap">
    ...
    <p>这个 Worker 用于把蝴蝶号分享链接解析成可用的视频详情，提供给 <code>wx_channel</code> 的 <code>cloudflare.sphHostname</code> 模式使用。</p>
    <div class="hint">支持的接口：<code>POST /api/fetch_video_profile</code>，请求体：<code>{"url":"https://weixin.qq.com/sph/xxx"}</code></div>
    <textarea id="urlInput" placeholder="粘贴蝴蝶号分享链接，例如 https://weixin.qq.com/sph/xxxx"></textarea>
    <div class="actions">
