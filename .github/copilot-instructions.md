...
## Project Overview
**蝴蝶号下载助手** (WeChat Channel Video Downloader) is a Windows desktop application written in Go 1.23+ that:
...
# With version info
go build -ldflags "-X wx_channel/internal/version.Version=v1.0.0" -o 蝴蝶号下载助手.exe
```
