...
// 定义 MIB_TCPROW2 结构体
#if !defined(_MIB_TCPROW2_DEFINED) && !defined(_INC_TCPMIB)
#define _MIB_TCPROW2_DEFINED
...
#if !defined(_MIB_TCPTABLE2_DEFINED) && !defined(_INC_TCPMIB)
#define _MIB_TCPTABLE2_DEFINED
...
typedef DWORD (WINAPI * GetTcpTable2Proc)(PMIB_TCPTABLE2 TcpTable, PULONG SizePointer, BOOL Order);
